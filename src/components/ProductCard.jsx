...
const ProductCard = ({ product, addToCart }) => {
  ...
  const handleAddToCart = () => {
    addToCart(product);
    setIsAdded(true);
    setTimeout(() => setIsAdded(false), 300); // Reset after animation
  };

  return (
    <div className=" border border-gray-300 rounded-lg shadow-sm hover:shadow-lg transition-shadow duration-300 ease-in-out w-full max-w-xs mx-auto sm:max-w-sm md:max-w-md lg:max-w-lg h-[400px] flex flex-col">
